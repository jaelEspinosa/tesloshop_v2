        ...
        <>   
{
  showModal && (
        <div style={{'zIndex': '99'}} className="fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50 py-10 backdrop-filter backdrop-blur-sm transition-all ">
          <div className="max-h-full sm:w-full w-80 max-w-xl overflow-y-auto sm:rounded-2xl rounded-xl bg-white">
            <div className="w-full p-2 p-auto">
              <div className="m-8 my-20 max-w-[400px] mx-auto">
                ...
                <div className="space-y-4">
                  <button className="m-auto p-3 bg-blue-500 hover:bg-blue-700 rounded-full text-white w-full font-semibold transition-colors"
                          onClick={placeOrder}
