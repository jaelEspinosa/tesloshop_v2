...
export const ProductForm = ({ product, categories }: Props) => {
  ...
  watch('sizes') // hace un renderizado si cambia el valor del campo sizes.
   ...
   // Asi el profesor
    ...
    // Asi lo hize yo 
       ...
       if(sizes.includes(size)){
            newSizesArray = sizes.filter(s => s !== size)
           }else{
            newSizesArray = [...sizes, size]
           }
           setValue('sizes', newSizesArray)  */
  }
